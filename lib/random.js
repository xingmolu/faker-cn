...
var random = {
    ...
    number: function (range) {
        return parseInt(Math.random()*(range.maximum - range.minimum + 1) + range.minimum); 
    },
    ...
    date: function(){
        var millisecondsOffset = Math.floor(Math.random() * 10000000000);

        var milliseconds = new Date().getTime() - millisecondsOffset;
